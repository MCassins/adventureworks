var custoproduto = angular.module('custoproduto', []);       
custoproduto.controller('AppCtrl', ['$scope', '$http', function($scope, $http) {   
	...
	var refresh = function(){
		 ...
		 function doneCallbacks(res) { 			
             //MUDA O NOME DA LISTA PRA listaNOMEDATABELA
 			$scope.listacustoproduto = res.data.metodoEnvio;
 			$scope.lista = {};
	...
	$scope.adicionar = function() {    	
        //PASSA OS PARAMETROS QUE NAO SAO STRING AQUI
