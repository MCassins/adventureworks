var producaoordemserviço = angular.module('producaoordemserviço', []);
producaoordemserviço.controller('AppCtrl', ['$scope', '$http', function($scope, $http) {   
	...
	var refresh = function(){
		 ...
		 function doneCallbacks(res) { 			
 			$scope.listaordemservico = res.data.metodoEnvio;
 			$scope.lista = {};
