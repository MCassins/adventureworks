var producaohistoricotransacoes = angular.module('producaohistoricotransacoes', []);
producaohistoricotransacoes.controller('AppCtrl', ['$scope', '$http', function($scope, $http) {   
	...
	var refresh = function(){
		 ...
		 function doneCallbacks(res) { 			
 			$scope.listahistoricotransacoes = res.data.metodoEnvio;
 			$scope.lista = {};
