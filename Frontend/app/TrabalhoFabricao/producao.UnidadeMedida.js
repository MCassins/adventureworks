var producaounidademedida = angular.module('producaounidademedida', []);
producaounidademedida.controller('AppCtrl', ['$scope', '$http', function($scope, $http) {   
	...
	var refresh = function(){
		 ...
		 function doneCallbacks(res) { 			
 			$scope.listaunidademedida = res.data.metodoEnvio;
 			$scope.lista = {};
