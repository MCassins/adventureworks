var producaomotivodescarte = angular.module('producaomotivodescarte', []);
producaomotivodescarte.controller('AppCtrl', ['$scope', '$http', function($scope, $http) {   
	...
	var refresh = function(){
		 ...
		 function doneCallbacks(res) { 			
 			$scope.listamotivodescarte = res.data.metodoEnvio;
 			$scope.lista = {};
