var administracaodatabase = angular.module('administracaodatabase', []);
administracaodatabase.controller('AppCtrl', ['$scope', '$http', function($scope, $http) {   
	...
	var refresh = function(){
		 ...
		 function doneCallbacks(res) { 			
 			$scope.databaselogs = res.data.metodoEnvio;
 			$scope.lista = {};
